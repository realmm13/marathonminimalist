    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">
          Your comprehensive training companion for marathon preparation
        </p>
      </div>
              ...
              <Link href="/profile" className="block">
                ...
                >
                  ...
                  <div className="space-y-1 text-left">
                    <p className="text-sm leading-none font-medium">Setup Profile</p>
                    <p className="text-muted-foreground text-xs">
                      Set marathon goals & preferences
                    </p>
                  </div>
                </Button>
              </Link>
