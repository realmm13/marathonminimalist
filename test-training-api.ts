...
import { TrainingScheduler } from './src/lib/training/training-scheduler';
...
async function testTrainingAPI() {
  try {
    ...
    const plan = trainingScheduler.generateScheduledPlan(
      startDate,
      endDate,
      userProfile.fitnessLevel as any,
      userProfile.weeklyMileage as any,
      userProfile.raceGoalTime as any
    );
